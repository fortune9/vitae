...
\renewcommand{\section}[1]{%
  $if(spacing_before_section_title)$%
  \vspace{$spacing_before_section_title$}%
  $endif$%
  \origsection{#1}%
  $if(spacing_after_section_title)$%
  \vspace{$spacing_after_section_title$}%
  $endif$%
}
\makeatother
...
% Modify an environment for cvitems(for cventry) to have less spacing at the end
